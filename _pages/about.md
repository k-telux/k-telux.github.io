...
I am a first-year graduate student from [the Chemistry PhD program](https://chemistry.brown.edu/graduate) at [Brown University](https://www.brown.edu/). I will join [Yusong Bai's Group](https://www.yusongbai.org/) after the first semester's rotation. You can find my academic CV [here](../assets/xzq_Resume.pdf)
...
After the setting up work for the system, our group published (Phys. Rev. Lett. 134, 053401)[https://doi.org/10.1103/PhysRevLett.134.053401]

At 2024 summer, I went to Rice University for a half year internship program and published (Nano Lett. 2025, 25, 29, 11226–11233)[https://doi.org/10.1021/acs.nanolett.5c01718]. I invastigated the single photon emission in few-layer transition-metal dichalcogenide (TMDC) and finished my bachlor degree thesis, which were supported by the [SCOPE lab](https://scopelab.rice.edu/) and led by [Prof. Shengxi Huang](https://profiles.rice.edu/faculty/shengxi-huang) and [Wenjing Wu](https://scholar.google.com/citations?user=lm68m7kAAAAJ) at Rice University. 

## Bachelor Research History
- Fiber cavity QED with cold atoms 
- Fiber microcavity fabrication, testing and high-vaccum system building
